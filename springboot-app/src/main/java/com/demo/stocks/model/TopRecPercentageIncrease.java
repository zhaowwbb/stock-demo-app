...
@Entity
@Table(name = "top_rec_percentage_increase")
@IdClass(RecommendationId.class)
public class TopRecPercentageIncrease {
    ...
    @Column(name = "price_increase_pct", nullable = false, precision = 8, scale = 4)
    private BigDecimal priceIncreasePct;
    ...
    public BigDecimal getPriceIncreasePct() { return priceIncreasePct; }
    public void setPriceIncreasePct(BigDecimal priceIncreasePct) { this.priceIncreasePct = priceIncreasePct; }
